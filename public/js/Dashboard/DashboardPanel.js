...
// Dashboard panels for live stream charts
class DashboardPanelSensorData extends DashboardPanel {
    load(parentDivId, divId, viewer, modelData){
        divId = this.idToUse + divId;
        super.load(parentDivId, divId, viewer);

        $('#' + divId).append('<canvas id="SensorLineChart" width="400" height="400"></canvas>');
