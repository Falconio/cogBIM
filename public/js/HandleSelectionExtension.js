class HandleSelectionExtension extends Autodesk.Viewing.Extension {
    ...
    load() {
        console.log('HandleSelectionExtensions has been loaded');
        return true;
    }
    ...
    unload() {
        ...
        console.log('HandleSelectionExtensions has been unloaded');
        return true;
    }

    onToolbarCreated() {
        // Create a new toolbar group if it doesn't exist
        this._group = this.viewer.toolbar.getControl('allForgeLoaderExtensionsToolbar');
        if (!this._group) {
            this._group = new Autodesk.Viewing.UI.ControlGroup('allForgeLoaderExtensionsToolbar');
